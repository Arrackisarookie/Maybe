...
(function() {
    ...
    function success(key, val) {
        ...
        let msg = '<li class="comment" style="color: #df846c;">è¯„è®ºå°†åœ¨é€šè¿‡åŽå±•ç¤º...</li>';
    ...
    function fail() {
        let text = document.getElementsByClassName('comment-list')[0];
        let msg = '<li class="comment" style="color: #df846c;">å‘å¸ƒè¯„è®ºå¤±è´¥...</li>';
