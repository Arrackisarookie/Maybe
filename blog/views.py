...
def tag_post(tag):
    ...
    return send_from_directory(
        'static', 'generated/page/tag/{tag}.html'.format(tag=tag))
...
def category_post(category):
    ...
    return send_from_directory(
        'static',
        'generated/page/category/{category}.html'.format(
            category=category))
...
def page(page):
    ...
    return send_from_directory(
        'static', 'generated/page/{page}.html'.format(page=page))
...
def post(year, month, post):
    ...
    return send_from_directory(
        'static',
        'generated/post/{year}/{month}/{post}.html'.format(
            year=year, month=month, post=post))
